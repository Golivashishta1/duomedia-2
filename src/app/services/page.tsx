...
// Using Poppins from the global fonts configuration
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20 pt-10">
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-6">
          <PlanCard
            ...
            theme="light"
            headingClassName={poppins.className}
          />
          <PlanCard
  ...
  return (
    ...
    >
      <div className={["relative z-10 p-6 md:p-7 lg:p-8", hasArt ? "md:pr-[48%]" : ""].join(" ")}>
        <h3
          className={`${poppins.className} whitespace-pre-line text-[34px] leading-[0.95] md:text-[40px] font-extrabold tracking-tight`}
        >
          {title}
        </h3>
...
function PlanCard({
  ...
  return (
    <div
      className={[
        "relative rounded-[22px] overflow-hidden ring-1",
        isDark ? "bg-[#0f1417] ring-white/10" : "bg-white ring-black/10",
      ].join(" ")}
    >
        ...
        <div className="mt-7">
          <Link
            ...
            className={[
              ...
              isDark ? "bg-[#111] text-white ring-1 ring-white/15 hover:bg:black" : "bg-[#111] text-white hover:bg-black",
            ].join(" ")}
          >
            Get Started
          </Link>
