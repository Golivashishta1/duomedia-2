...
/* Rowdies heading helper */
const heading = poppins.className;
          ...
          <div className="lg:col-span-7">
            <div className="rounded-2xl bg-[#121212] ring-1 ring-white/10 p-5 md:p-7">
              <h3 className={`${heading} text-2xl font-extrabold`}>
                {isBrand ? "I Am Brand" : "I Am Influencer"}
              </h3>
  ...
  return (
    <section className="relative overflow-hidden pt-8 pb-24">
      <div className="text-center px-6">
        <h2
          className={`${heading} text-[#D6FF21] text-4xl md:text-6xl font-extrabold leading-[1.05] tracking-tight`}
        >
          Trends. Creator tea.
